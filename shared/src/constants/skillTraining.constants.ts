 ...
 *
 * Defines dedicated training activities for all 30 skills.
...
export const COMBAT_TRAINING_ACTIVITIES: SkillTrainingActivity[] = [
  // MELEE COMBAT - Brawling
  {
    ...
    cooldownSeconds: 120,
    minLevel: 1,
    locationTypes: ['saloon', 'tavern', 'outlaw_camp', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
  ...
  // RANGED COMBAT - Target Practice
  {
    ...
    cooldownSeconds: 120,
    minLevel: 1,
    locationTypes: ['shooting_range', 'fort', 'ranch', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
  ...
  // DEFENSIVE TACTICS - Sparring
  {
    ...
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['saloon', 'fort', 'gang_hideout', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
  ...
  // MOUNTED COMBAT - Cavalry Drills
  {
    ...
    cooldownSeconds: 300,
    minLevel: 1,
    locationTypes: ['stable', 'ranch', 'fort', 'skill_academy'],
    baseSkillXP: 30,
    baseCharacterXP: 20,
  ...
  // EXPLOSIVES - Demolition Work
  {
    ...
    cooldownSeconds: 600,
    minLevel: 10,
    locationTypes: ['mine', 'quarry', 'construction', 'skill_academy'],
    baseSkillXP: 40,
    baseCharacterXP: 30,
...
export const CUNNING_TRAINING_ACTIVITIES: SkillTrainingActivity[] = [
  // LOCKPICKING - Lock Challenges
  {
    ...
    cooldownSeconds: 120,
    minLevel: 1,
    locationTypes: ['locksmith', 'thieves_guild', 'outlaw_camp', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
    baseGoldReward: { min: 5, max: 15 },
    riskLevel: 'safe',
  ...
  // STEALTH - Sneaking Practice
  {
    ...
    cooldownSeconds: 120,
    minLevel: 1,
    locationTypes: ['town', 'market', 'camp', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
    baseGoldReward: { min: 5, max: 15 },
    riskLevel: 'low',
  ...
  // PICKPOCKET - Finger Practice
  {
    ...
    cooldownSeconds: 120,
    minLevel: 1,
    locationTypes: ['thieves_guild', 'outlaw_camp', 'market', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
  ...
  // TRACKING - Wildlife Tracking
  {
    ...
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['wilderness', 'forest', 'plains', 'mountains', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
    baseGoldReward: { min: 10, max: 25 },
    riskLevel: 'low',
  ...
  // DECEPTION - Con Games
  {
    ...
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['saloon', 'market', 'town', 'skill_academy'],
    baseSkillXP: 30,
    baseCharacterXP: 20,
  ...
  // GAMBLING - Card Games (already exists in tavern, but adding training version)
  {
    ...
    cooldownSeconds: 120,
    minLevel: 1,
    locationTypes: ['saloon', 'casino', 'riverboat', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
  ...
  // DUEL INSTINCT - Duel Practice
  {
    ...
    cooldownSeconds: 300,
    minLevel: 5,
    locationTypes: ['dueling_grounds', 'saloon', 'fort', 'skill_academy'],
    baseSkillXP: 35,
    baseCharacterXP: 25,
...
export const SPIRIT_TRAINING_ACTIVITIES: SkillTrainingActivity[] = [
  // MEDICINE - Doctoring
  {
    ...
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['hospital', 'clinic', 'camp', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
    baseGoldReward: { min: 10, max: 25 },
    riskLevel: 'safe',
  ...
  // PERSUASION - Negotiations
  {
    ...
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['town_hall', 'saloon', 'church', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
  ...
  // ANIMAL HANDLING - Train Animals
  {
    ...
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['stable', 'ranch', 'farm', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
    baseGoldReward: { min: 10, max: 30 },
    riskLevel: 'low',
  ...
  // LEADERSHIP - Gang Leadership (requires gang)
  {
    ...
    cooldownSeconds: 600,
    minLevel: 1,
    locationTypes: ['gang_hideout', 'skill_academy'],
    baseSkillXP: 35,
    baseCharacterXP: 25,
  ...
  // RITUAL KNOWLEDGE - Ritual Practice
  {
    ...
    cooldownSeconds: 600,
    minLevel: 10,
    locationTypes: ['sacred_site', 'temple', 'graveyard', 'skill_academy'],
    baseSkillXP: 40,
    baseCharacterXP: 30,
  ...
  // PERFORMANCE - Entertainment
  {
    ...
    cooldownSeconds: 120,
    minLevel: 1,
    locationTypes: ['saloon', 'theater', 'town_square', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
...
export const CRAFT_TRAINING_ACTIVITIES: SkillTrainingActivity[] = [
  // BLACKSMITHING - Forge Work
  {
    ...
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['smithy', 'forge', 'workshop', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
    baseGoldReward: { min: 10, max: 25 },
    riskLevel: 'safe',
  ...
  // LEATHERWORKING - Tanning
  {
    ...
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['tannery', 'workshop', 'camp', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
    baseGoldReward: { min: 10, max: 25 },
    riskLevel: 'safe',
  ...
  // COOKING - Cook Meals
  {
    ...
    cooldownSeconds: 120,
    minLevel: 1,
    locationTypes: ['kitchen', 'camp', 'saloon', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
    baseGoldReward: { min: 10, max: 30 },
    riskLevel: 'safe',
  ...
  // ALCHEMY - Brew Potions (supplements gathering)
  {
    ...
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['apothecary', 'workshop', 'camp', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
    baseGoldReward: { min: 15, max: 35 },
    riskLevel: 'low',
  ...
  // ENGINEERING - Tinkering
  {
    ...
    cooldownSeconds: 300,
    minLevel: 5,
    locationTypes: ['workshop', 'factory', 'mine', 'skill_academy'],
    baseSkillXP: 30,
    baseCharacterXP: 20,
  ...
  // PROSPECTING - Mine Ore (supplements gathering)
  {
    id: 'mine_ore',
    name: 'Mine Ore',
    ...
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['mine', 'quarry', 'cave', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
    baseGoldReward: { min: 15, max: 35 },
    riskLevel: 'low',
  ...
  // WOODWORKING - Woodworking (supplements gathering)
  {
    id: 'woodworking_practice',
    name: 'Woodworking',
    ...
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['lumber_camp', 'workshop', 'construction', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
    baseGoldReward: { min: 10, max: 30 },
    riskLevel: 'safe',
  ...
  // GUNSMITHING - Gun Maintenance
  {
    ...
    cooldownSeconds: 300,
    minLevel: 5,
    locationTypes: ['gun_shop', 'workshop', 'fort', 'skill_academy'],
    baseSkillXP: 30,
    baseCharacterXP: 20,
    baseGoldReward: { min: 20, max: 50 },
    riskLevel: 'low',
  ...
  // TAILORING - Sewing Practice
  {
    id: 'sewing_practice',
    name: 'Sewing Practice',
    description: 'Work with fabric and thread at the tailor shop',
    skillId: 'tailoring',
    category: SkillCategory.CRAFT,
    energyCost: 12,
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['tailor', 'workshop', 'general_store', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 15,
    baseGoldReward: { min: 10, max: 30 },
    riskLevel: 'safe',
    successMessages: [
      ...
      'The garment comes together beautifully.',
      'The tailor admires your neat handiwork.'
    ],
    failureMessages: [
      'You prick your finger and bleed on the fabric.',
      'The seam is crooked and has to be redone.',
      'Thread keeps tangling in the needle.'
    ]
  },

  // NATIVE CRAFTS - Traditional Crafting
  {
    id: 'traditional_crafting',
    name: 'Traditional Crafting',
    description: 'Learn traditional crafting techniques from tribal elders',
    skillId: 'native_crafts',
    category: SkillCategory.CRAFT,
    energyCost: 15,
    cooldownSeconds: 240,
    minLevel: 1,
    locationTypes: ['tribal_village', 'sacred_site', 'trading_post', 'skill_academy'],
    baseSkillXP: 30,
    baseCharacterXP: 20,
    baseGoldReward: { min: 10, max: 25 },
    riskLevel: 'safe',
    successMessages: [
      'The elder nods approvingly at your work.',
      'You weave the beads in the traditional pattern.',
      'The medicine bag holds sacred power.'
    ],
    failureMessages: [
      'You dishonor the materials with clumsy work.',
      'The pattern is wrong - it must be undone.',
      'The elder shakes their head and starts over.'
    ]
  },

  // TRAPPING - Set Trap Lines
  {
    id: 'set_trap_lines',
    name: 'Set Trap Lines',
    description: 'Check and maintain trap lines in the wilderness',
    skillId: 'trapping',
    category: SkillCategory.CRAFT,
    energyCost: 15,
    cooldownSeconds: 240,
    minLevel: 1,
    locationTypes: ['wilderness', 'forest', 'mountains', 'camp', 'skill_academy'],
    baseSkillXP: 30,
    baseCharacterXP: 20,
    baseGoldReward: { min: 15, max: 40 },
    riskLevel: 'low',
    successMessages: [
      'You find a fine pelt waiting in your trap.',
      'The trap springs perfectly - a clean catch.',
      'Today\'s haul will fetch good money.'
    ],
    failureMessages: [
      'The trap was triggered but the animal escaped.',
      'Scavengers got to your catch first.',
      'Empty traps - the animals are wary today.'
    ]
  }
];
...
export const LAWMAN_TRAINING_ACTIVITIES: SkillTrainingActivity[] = [
  // PATROL DUTY - Uses tracking skill, awards +3 moral reputation
  {
    ...
    cooldownSeconds: 180,
    minLevel: 1,
    locationTypes: ['town', 'settlement', 'fort', 'outpost', 'skill_academy'],
    baseSkillXP: 20,
    baseCharacterXP: 15,
    baseGoldReward: { min: 5, max: 15 },
    riskLevel: 'safe',
  ...
  // REPORT CRIME - Uses persuasion skill, awards +2 moral reputation
  {
    ...
    cooldownSeconds: 120,
    minLevel: 1,
    locationTypes: ['town', 'settlement', 'fort', 'sheriff_office', 'skill_academy'],
    baseSkillXP: 15,
    baseCharacterXP: 10,
    baseGoldReward: { min: 5, max: 20 },
    riskLevel: 'safe',
  ...
  // PROTECT CIVILIAN - Uses defensive_tactics, awards +5 moral reputation
  {
    ...
    cooldownSeconds: 240,
    minLevel: 1,
    locationTypes: ['town', 'settlement', 'saloon', 'market', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 20,
    baseGoldReward: { min: 10, max: 30 },
    riskLevel: 'low',
  ...
  // GUARD DUTY - Uses defensive_tactics, awards +3 moral reputation
  {
    ...
    cooldownSeconds: 300,
    minLevel: 1,
    locationTypes: ['town', 'bank', 'fort', 'jail', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 18,
    baseGoldReward: { min: 15, max: 35 },
    riskLevel: 'low',
  ...
  // FIRST AID STATION - Uses medicine, awards +5 moral reputation
  {
    ...
    cooldownSeconds: 240,
    minLevel: 1,
    locationTypes: ['clinic', 'hospital', 'church', 'camp', 'skill_academy'],
    baseSkillXP: 25,
    baseCharacterXP: 20,
    baseGoldReward: { min: 10, max: 25 },
    riskLevel: 'safe',
  ...
  // DEPUTY TRAINING - Uses ranged_combat, awards +3 moral reputation
  {
    ...
    cooldownSeconds: 300,
    minLevel: 1,
    locationTypes: ['sheriff_office', 'fort', 'shooting_range', 'skill_academy'],
    baseSkillXP: 30,
    baseCharacterXP: 20,
    baseGoldReward: { min: 10, max: 25 },
    riskLevel: 'safe',
