...
export const ARTIFACT_SETS: IArtifactSet[] = [
  ...
  },
  {
    ...
    bonuses: [
      {
        requiredCount: 2,
        effects: [{ stat: 'spirit', value: 10, description: '+10 Spirit' }],
      },
      {
        requiredCount: 3,
        effects: [
          { stat: 'spirit', value: 20, description: '+20 Spirit' },
      ...
      },
      {
        requiredCount: 5,
        effects: [
          { stat: 'spirit', value: 35, description: '+35 Spirit' },
