/**
 * Duel Error Fallback Component
 * Displays when Duel page encounters an error
 * Provides navigation back to duel list
 */

import { ArrowLeft, RefreshCw, AlertTriangle } from 'lucide-react';
import { useNavigate } from 'react-router-dom';

interface DuelErrorFallbackProps {
  error?: Error;
  resetError?: () => void;
}

export function DuelErrorFallback({ error, resetError }: DuelErrorFallbackProps) {
    ...
    <div className="min-h-screen bg-wood-darker flex items-center justify-center p-6">
      <div className="max-w-2xl w-full bg-wood-dark rounded-xl shadow-2xl p-8 border-4 border-wood-medium">
        ...
        <p className="text-lg text-desert-dust text-center mb-6">
          Something went wrong with the duel system. Your character is safe and can return to dueling.
        </p>
