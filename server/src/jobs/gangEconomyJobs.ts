  ...
  try {
    ...
    for (const business of businesses) {
      try {
        ...
        logger.error(`[GangEconomy] Error processing business ${business._id}:`, error);
      }
    }
  ...
  try {
    ...
    for (const business of businesses) {
      try {
        ...
        logger.error(`[GangEconomy] Error processing raid check for business ${business._id}:`, error);
      }
    }
  ...
  try {
    ...
    for (const economy of economies) {
      try {
        ...
        logger.error(`[GangEconomy] Error processing payroll for gang ${economy.gangId}:`, error);
      }
    }
  ...
  try {
    ...
    for (const investment of investments) {
      try {
        ...
        logger.error(`[GangEconomy] Error processing investment ${investment._id}:`, error);
      }
    }
  ...
  try {
    ...
    for (const economy of economies) {
      try {
        ...
        logger.error(`[GangEconomy] Error processing interest for gang ${economy.gangId}:`, error);
      }
    }
