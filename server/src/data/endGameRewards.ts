...
export const DAILY_CHALLENGES: DailyChallenge[] = [
  ...
  // New Prestige Daily Challenges
  {
    id: 'void_ritual_interrupt',
    type: DailyChallengeType.CORRUPTION_CLEANSE,
    name: 'Void Ritual Interruption',
    description: 'Stop 3 active cultist rituals before completion',
    zone: ScarZone.DEEP_SCAR,
    objective: {
      type: 'cleanse',
      target: 'void_ritual',
    ...
    rewards: {
      ...
      items: [
        {
          itemId: 'disrupted_ritual_essence',
          name: 'Disrupted Ritual Essence',
          rarity: 'epic',
          dropChance: 0.9,
          minQuantity: 1,
          maxQuantity: 2,
  ...
  {
    id: 'reality_anchor_repair',
    type: DailyChallengeType.ARTIFACT_FRAGMENT,
    name: 'Reality Anchor Repair',
    description: 'Repair 4 damaged reality anchors in the Twisted Lands',
    zone: ScarZone.TWISTED_LANDS,
    objective: {
      type: 'find',
    ...
    rewards: {
      ...
      items: [
        {
          itemId: 'stable_reality_shard',
          name: 'Stable Reality Shard',
          rarity: 'rare',
          dropChance: 1.0,
          minQuantity: 2,
          maxQuantity: 3,
  ...
  {
    id: 'lost_soul_collector',
    type: DailyChallengeType.SURVIVOR_RESCUE,
    name: 'Soul Collection',
    description: 'Collect 10 lost souls wandering the Outer Waste',
    zone: ScarZone.OUTER_WASTE,
    objective: {
      type: 'rescue',
      target: 'lost_soul',
  ...
  {
    id: 'cosmic_alignment_actions',
    type: DailyChallengeType.SCAR_PATROL,
    name: 'Cosmic Alignment Harvest',
    description: 'Complete 15 actions during a cosmic event',
    zone: ScarZone.THE_ABYSS,
    objective: {
      type: 'kill',
      target: 'cosmic_event_action',
      quantity: 15,
    },
    rewards: {
      gold: 700,
      ...
      items: [
        {
          itemId: 'cosmic_alignment_crystal',
          name: 'Cosmic Alignment Crystal',
          rarity: 'legendary',
          dropChance: 0.5,
          minQuantity: 1,
          maxQuantity: 1,
...
export const WEEKLY_CHALLENGES: WeeklyChallenge[] = [
  ...
  // New Prestige Weekly Challenges
  {
    id: 'legendary_hunt_cosmic_serpent',
    type: WeeklyChallengeType.ELITE_HUNT,
    name: 'Hunt: The Cosmic Serpent',
    description: 'Track and defeat The Cosmic Serpent in its dimensional lair',
    zone: ScarZone.THE_ABYSS,
    objective: {
      type: 'hunt',
      target: 'cosmic_serpent',
      difficulty: 10,
    },
    rewards: {
      gold: 3000,
  ...
  {
    id: 'legendary_hunt_timeless_coyote',
    type: WeeklyChallengeType.ELITE_HUNT,
    name: 'Hunt: The Timeless Coyote',
    description: 'Track the time-bending Coyote and survive its temporal tricks',
    zone: ScarZone.TWISTED_LANDS,
    objective: {
      type: 'hunt',
      target: 'timeless_coyote',
      difficulty: 10,
    },
    rewards: {
      gold: 3500,
  ...
  },
  {
    id: 'abyss_deep_dive',
    type: WeeklyChallengeType.DEEP_EXPEDITION,
    name: 'Deep Dive: The Lowest Point',
    description: 'Reach the deepest level of The Abyss without dying',
    zone: ScarZone.THE_ABYSS,
    objective: {
      type: 'expedition',
      difficulty: 10,
      requirements: ['Reach depth level 10', 'No deaths', 'Sanity above 25%'],
    },
    rewards: {
      gold: 4000,
      experience: 20000,
      ...
      bonusItems: [
        {
          itemId: 'void_essence_concentrated',
          name: 'Concentrated Void Essence',
          rarity: 'legendary',
          dropChance: 0.8,
          minQuantity: 2,
          maxQuantity: 4,
  ...
  {
    id: 'corruption_master_trial',
    type: WeeklyChallengeType.RITUAL_DISRUPTION,
    name: 'Corruption Master Trial',
    description: 'Use 10 different corruption abilities in a single expedition',
    zone: ScarZone.DEEP_SCAR,
    objective: {
      type: 'disruption',
      difficulty: 8,
      requirements: ['Use 10 corruption abilities', 'Complete expedition', 'Corruption below 80%'],
    },
    rewards: {
      gold: 2500,
      experience: 12000,
      ...
      guaranteedItems: [
        {
          itemId: 'corruption_mastery_token',
          name: 'Corruption Mastery Token',
          rarity: 'legendary',
          dropChance: 1.0,
          minQuantity: 1,
          maxQuantity: 1,
  ...
  {
    id: 'reality_restoration',
    type: WeeklyChallengeType.RELIC_RECOVERY,
    name: 'Reality Restoration',
    description: 'Cleanse all corruption nodes in a single zone',
    zone: ScarZone.OUTER_WASTE,
    objective: {
      type: 'recovery',
      difficulty: 7,
      requirements: ['Find all corruption nodes', 'Cleanse each node', 'Defend restored areas'],
    },
    rewards: {
      gold: 2000,
      experience: 10000,
      ...
      guaranteedItems: [
        {
          itemId: 'reality_restoration_badge',
          name: 'Reality Restoration Badge',
          rarity: 'legendary',
          dropChance: 1.0,
          minQuantity: 1,
          maxQuantity: 1,
      ...
      bonusItems: [
        {
          itemId: 'pure_reality_essence',
          name: 'Pure Reality Essence',
          rarity: 'epic',
          dropChance: 0.7,
          minQuantity: 2,
          maxQuantity: 3,
  ...
  {
    id: 'multi_elite_gauntlet',
    type: WeeklyChallengeType.ELITE_HUNT,
    name: 'Elite Gauntlet',
    description: 'Defeat 5 elite corrupted creatures in succession without resting',
    zone: ScarZone.DEEP_SCAR,
    objective: {
      type: 'hunt',
      target: 'elite_corrupted',
      difficulty: 9,
    },
    rewards: {
      gold: 3000,
      ...
      guaranteedItems: [
        {
          itemId: 'elite_hunter_trophy',
          name: 'Elite Hunter Trophy',
          rarity: 'legendary',
          dropChance: 1.0,
          minQuantity: 1,
          maxQuantity: 1,
  ...
  },
  {
    id: 'sangre_legacy',
    type: WeeklyChallengeType.ELITE_HUNT,
    name: "General Sangre's Legacy",
    description: "Complete the General Sangre's Shade encounter and recover his lost artifacts",
    zone: ScarZone.TWISTED_LANDS,
    objective: {
      type: 'hunt',
      target: 'sangre_shade',
  ...
  {
    id: 'cosmic_truth_preparation',
    type: WeeklyChallengeType.DEEP_EXPEDITION,
    name: 'Cosmic Truth Preparation',
    description: 'Gather materials needed for the final cosmic confrontation',
    zone: ScarZone.THE_ABYSS,
    objective: {
      type: 'expedition',
      difficulty: 10,
      requirements: ['Collect 5 void crystals', 'Collect 3 reality cores', 'Reach corruption mastery 50'],
    },
    rewards: {
      gold: 5000,
      experience: 25000,
      ...
      guaranteedItems: [
        {
          itemId: 'truth_seeker_token',
          name: 'Truth Seeker Token',
          rarity: 'mythic',
          dropChance: 1.0,
          minQuantity: 1,
          maxQuantity: 1,
      ...
      bonusItems: [
        {
          itemId: 'cosmic_resonance_crystal',
          name: 'Cosmic Resonance Crystal',
          rarity: 'mythic',
          dropChance: 0.4,
          minQuantity: 1,
          maxQuantity: 1,
